...
from app.crud.food import get_food, get_foods, create_food, update_food, delete_food, get_category
from app.schemas.food import FoodCreate, FoodUpdate, FoodInDB
...
async def read_foods(
    ...
    """
    Get all foods with optional category filtering and pagination.
    """
